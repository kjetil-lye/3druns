...
kh_1hdf5 = NetCDFReader(FileName=['/scratch/snx3000/klye/3druns/kelvinhelmholtz_3d_tube/single/kelvinhelmholtz_64_0.1/kh_1.hdf5'])
...
kh_1hdf5Display.ScalarOpacityUnitDistance = 1.7320508075688774
kh_1hdf5Display.Slice = 31
...
sample_0_rhoLUT.RGBPoints = [0.9784175753593445, 0.231373, 0.298039, 0.752941, 1.5174220502376556, 0.865003, 0.865003, 0.865003, 2.056426525115967, 0.705882, 0.0156863, 0.14902]
...
sample_0_rhoPWF.Points = [0.9784175753593445, 0.0, 0.5, 0.0, 2.056426525115967, 1.0, 0.5, 0.0]
...
sample_0_rhoLUT.RescaleTransferFunction(1.1, 2.15)

# Rescale transfer function
sample_0_rhoPWF.RescaleTransferFunction(1.1, 2.15)
...
renderView1.CameraPosition = [189.68917717694458, 151.153741040849, 102.89114402174519]
renderView1.CameraFocalPoint = [31.499999999999964, 31.499999999999975, 31.50000000000001]
renderView1.CameraViewUp = [-0.3128110503274397, 0.7563477537120549, -0.5745322638875668]
renderView1.CameraParallelScale = 54.559600438419636

# save screenshot
SaveScreenshot('/home/kjetil/projects/3druns/postprocessing/paraview_scripted_plots/kh/single/kh_64_1.png', renderView1, ImageResolution=[3840, 2160])

# hide data in view
Hide(kh_1hdf5, renderView1)

# create a new 'NetCDF Reader'
kh_1hdf5_1 = NetCDFReader(FileName=['/scratch/snx3000/klye/3druns/kelvinhelmholtz_3d_tube/single/kelvinhelmholtz_128_0.1/kh_1.hdf5'])
...
# current camera placement for renderView1
renderView1.CameraPosition = [382.3892936741572, 304.7067478125045, 207.41548080573983]
renderView1.CameraFocalPoint = [63.5, 63.5, 63.5]
renderView1.CameraViewUp = [-0.3128110503274397, 0.7563477537120549, -0.5745322638875668]
renderView1.CameraParallelScale = 109.9852262806237

# save screenshot
SaveScreenshot('/home/kjetil/projects/3druns/postprocessing/paraview_scripted_plots/kh/single/kh_128_1.png', renderView1, ImageResolution=[3840, 2160])

# hide data in view
Hide(kh_1hdf5_1, renderView1)

# create a new 'NetCDF Reader'
kh_1hdf5_2 = NetCDFReader(FileName=['/scratch/snx3000/klye/3druns/kelvinhelmholtz_3d_tube/single/kelvinhelmholtz_256_0.1/kh_1.hdf5'])
...
# current camera placement for renderView1
renderView1.CameraPosition = [767.7895266685834, 611.8127613558161, 416.4641543737296]
renderView1.CameraFocalPoint = [127.5, 127.5, 127.5]
renderView1.CameraViewUp = [-0.3128110503274397, 0.7563477537120549, -0.5745322638875668]
renderView1.CameraParallelScale = 220.83647796503186

# save screenshot
SaveScreenshot('/home/kjetil/projects/3druns/postprocessing/paraview_scripted_plots/kh/single/kh_256_1.png', renderView1, ImageResolution=[1216, 799])

# hide data in view
Hide(kh_1hdf5_2, renderView1)

# create a new 'NetCDF Reader'
kh_1hdf5_3 = NetCDFReader(FileName=['/scratch/snx3000/klye/3druns/kelvinhelmholtz_3d_tube/single/kelvinhelmholtz_512_0.1/kh_1.hdf5'])
...
# current camera placement for renderView1
renderView1.CameraPosition = [1538.5899926574357, 1226.024788442439, 834.561501509709]
renderView1.CameraFocalPoint = [255.5, 255.5, 255.5]
renderView1.CameraViewUp = [-0.3128110503274397, 0.7563477537120549, -0.5745322638875668]
renderView1.CameraParallelScale = 442.53898133384814

# save screenshot
SaveScreenshot('/home/kjetil/projects/3druns/postprocessing/paraview_scripted_plots/kh/single/kh_512_1.png', renderView1, ImageResolution=[3840, 2160])

# hide data in view
Hide(kh_1hdf5_3, renderView1)

# create a new 'NetCDF Reader'
kh_1hdf5_4 = NetCDFReader(FileName=['/scratch/snx3000/klye/3druns/kelvinhelmholtz_3d_tube/single/kelvinhelmholtz_1024_0.1/kh_1.hdf5'])
...
kh_1hdf5_4Display.ScalarOpacityUnitDistance = 1.7320508075688772
kh_1hdf5_4Display.Slice = 511
...
# current camera placement for renderView1
renderView1.CameraPosition = [3080.1909246351406, 2454.4488426156854, 1670.756195781668]
renderView1.CameraFocalPoint = [511.5, 511.5, 511.5]
renderView1.CameraViewUp = [-0.3128110503274397, 0.7563477537120549, -0.5745322638875668]
renderView1.CameraParallelScale = 885.9439880714807

# save screenshot
SaveScreenshot('/home/kjetil/projects/3druns/postprocessing/paraview_scripted_plots/kh/single/kh_1024_1.png', renderView1, ImageResolution=[3840, 2160])
